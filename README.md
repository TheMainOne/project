...
1. [API Endpoints для управления пользователями](#api-endpoints-для-управления-пользователями)
   - [Регистрация нового пользователя](#1-регистрация-нового-пользователя)Регистрация нового пользователя
   - [Логинизация пользователя](#2-логинизация-пользователя)
   - [Логаут пользователя](#3-логаут-пользователя)
2. [API Endpoints для управления материалами](#api-endpoints-для-управления-материалами)
   - [Получение всех материалов](#1-получение-всех-материалов)
   - [Добавление нового материала](#3-добавление-нового-материала)
   - [Изменение существующего материала](#4-изменение-существующего-материала)
   - [Удаление материала](#5-удаление-материала)
3. [API Endpoints для управления регулирующими актами](#api-endpoints-для-управления-регулирующими-актами)
   ...
   - [Изменение регулирующего акта](#4-изменение-регулирующего-акта)
