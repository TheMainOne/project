...
1. [API Endpoints для управления материалами](#api-endpoints-для-управления-материалами)
   - [Получение всех материалов](#1-получение-всех-материалов)
   - [Добавление нового материала](#2-добавление-нового-материала)
2. [API Endpoints для управления регулирующими актами](#api-endpoints-для-управления-регулирующими-актами)
